const consts = function() {
	...
	const statusMoves = ["poisonpowder", "stunspore", "sleeppowder", "toxic"];
		...
		instruct: {
			...
			onHit(target, source) {
				...
				this.queue.prioritizeAction(this.queue.resolveAction({
					...
					targetLoc: target.lastMoveTargetLoc ?? null,
				})[0]);
			},
			secondary: null,
			target: "normal",
	...
	const defaultFront = "ani";
	const defaultBack = "ani-back";
	const defaultShiny = "ani-shiny";
	const defaultSubstitute = "gen5";
	...
	const spriteSets = {
		...
		digimon: {
			directory: "digimon/sprites/pokemon",
			front: true,
			back: true,
			shiny: true,
			substitute: "gen1",
	...
	const icons = ["gen5", "gen6"];

	const backdrops = ["alpha.png","angry.png","bg-beach.png","bg-beachshore.png","bg-city.png","bg-dampcave.png","bg-deepsea.png","bg-desert.png","bg-earthycave.png","bg-forest.png","bg-gen1-spl.png","bg-gen1.png","bg-gen2-spl.png","bg-gen2.png","bg-gen3-arena.png","bg-gen3-cave.png","bg-gen3-forest.png","bg-gen3-ocean.png","bg-gen3-sand.png","bg-gen3-spl.png","bg-gen3.png","bg-gen4-cave.png","bg-gen4-indoors.png","bg-gen4-snow.png","bg-gen4-spl.png","bg-gen4-water.png","bg-gen4.png","bg-icecave.png","bg-meadow.png","bg-mountain.png","bg-river.png","bg-route.png","bg-space.jpg","bg-spl.png","bg-thunderplains.png","bg-volcanocave.png","bg.jpg","bg.png","blackwisp.png","bluefireball.png","bone.png","bottombite.png","caltrop.png","client-bg-charizards.jpg","client-bg-horizon.jpg","client-bg-ocean.jpg","client-bg-psday.jpg","client-bg-shaymin.jpg","client-bg-waterfall.jpg","client-bg.jpg","client-bgsheet.png","client-topbar-bg.png","closebuttonsheet.png","electroball.png","energyball.png","faintleft.png","faintright.png","feather.png","fireball.png","fist.png","fist1.png","flareball.png","foot.png","gear.png","gender-f.png","gender-m.png","greenmetal1.png","greenmetal2.png","groupchat.png","hangman0.png","hangman1.png","hangman2.png","hangman3.png","hangman4.png","hangman5.png","hangman6.png","hangman7.png","heart.png","hitmarker.png","iceball.png","icicle-pink.png","icicle.png","impact.png","item.png","leaf1.png","leaf2.png","leftchop.png","leftclaw.png","leftslash.png","lightning.png","mafia-cop.png","mafia-dead.png","mafia-doctor.png","mafia-fool.png","mafia-godfather.png","mafia-goon.png","mafia-hooker.png","mafia-mafia.png","mafia-mayor.png","mafia-villager.png","mafia-werewolf.png","mail.png","mistball.png","mudwisp.png","mute.png","omega.png","petal.png","pointer.png","poisoncaltrop.png","poisonwisp.png","pokeball.png","rainbow.png","rightchop.png","rightclaw.png","rightslash.png","rock1.png","rock2.png","rock3.png","rocks.png","shadowball.png","shell.png","shine.png","sound.png","stare.png","switchleft.png","switchright.png","sword.png","topbite.png","ultra.png","versus.png","waterwisp.png","weather-electricterrain.png","weather-gen6-hail.mp4","weather-gen6-hail.webm","weather-gen6-raindance.mp4","weather-gen6-raindance.webm","weather-gen6-sandstorm.mp4","weather-gen6-sandstorm.webm","weather-gen6-sunnyday.mp4","weather-gen6-sunnyday.webm","weather-grassyterrain.png","weather-gravity.png","weather-hail.png",
		"weather-magicroom.png","weather-mistyterrain.png","weather-psychicterrain.png","weather-raindance.jpg","weather-sandstorm.png","weather-strongwind.png","weather-sunnyday.jpg","weather-trickroom.png","weather-wonderroom.png","web.png","wisp.png","z-symbol.png"];
